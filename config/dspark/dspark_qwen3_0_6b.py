...
exp_name = "dspark_block7_qwen3_0_6b"
seed = 42
...
model = dict(
    ...
    block_size=7,
    num_draft_layers=5,
    # Qwen3-0.6B has 28 decoder layers; pick 5 evenly-spaced layers and never
    # the final layer (28-1=27) — see eval assert_no_final_target_layer.
